    ...
    return (
        <div className="about-container">
            ...
            <p>Fondée à Richelieu et transmise à travers trois générations, O.G. Réfrigération incarne l'excellence et
                ...
                débuts, l'entreprise a su évoluer tout en restant fidèle à l'engagement de qualité instauré par son
                fondateur, Omer Gougeon et ses fils Michel et Marc. Initialement axée sur les besoins locaux, notre
                entreprise a su s'adapter aux
            ...
            <div className="about-section">
                <div className="text-content">
                    ...
                    <p>Notre vision repose sur les principes d'authenticité et de fiabilité,
                        ...
                        reconnues telles que Fujitsu et York pour garantir une qualité inégalée. Fiers de notre
                        expertise, nous nous engageons à offrir une expérience personnalisée et adaptée aux besoins
                        spécifiques de chaque client. Notre approche centrée sur le client nous permet de comprendre et
                        de répondre efficacement à leurs attentes, assurant ainsi des solutions de chauffage, de
                        climatisation et de réfrigération qui allient performance et durabilité.</p>
                </div>
